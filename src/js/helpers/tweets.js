const tweetsHelper = {
    generateTweet: (index) => {
        ...
        return {
            ...
            date: createdAt,
            image: 2 === Math.floor(Math.random() * 3) ? `http://lorempixel.com/500/280/technics/${index % 10}` : undefined,
            ...
            shares: {
                ...
                answered: !Math.floor(Math.random() * 10),
                liked: !Math.floor(Math.random() * 4),
                retweeted: !Math.floor(Math.random() * 4)
            }
        };
    },
